  ...
  return (
    <div className="flex flex-col gap-5 mx-auto  pb-2 px-4 w-[100%]">
      <div className="flex flex-col sm:flex-row justify-between items-center w-[90%] mt-8 mx-auto">
        <div className="flex flex-col gap-2 w-[100%] sm:w-[70%] md:w-[90%] lg:w-[45%]">
          <p className="text-[2.4rem] sm:text-[3rem] md:text-[3.5rem]  font-bold sm:text-start text-center">
            Read Our <span className="bg-yellow_light px-2">Blogs</span>
          </p>
          <p className="text-[0.9rem] sm:text-[1rem] md:text-[1.1rem] sm:w-[98%] w-[100%] sm:text-start text-center">
