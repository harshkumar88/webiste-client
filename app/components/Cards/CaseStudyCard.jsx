const CaseStudyCard = ({ item }) => {
  return (
    <div className="w-[97%] sm:w-[48%] md:w-[34%] lg:w-[22%] bg-green_gradient flex-shrink-0 border border-yellow_light text-white rounded-3xl p-6 sm:p-8 shadow-lg flex flex-col gap-6 relative overflow-hidden">
      {/* Main Image */}
      <img
        src={item.img}
        alt="Main Content"
