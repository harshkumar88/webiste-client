const StateMent = () => {
  return (
    <div
      className="md:w-[60%] w-[100%] bg-yellow_light md:p-0 sm:mt-10  pb-10 flex flex-col items-center justify-center relative"
      style={{ borderRadius: "0px 100px 100px 0px" }}
      id="resources"
    >
      <img src="/Statement/img2.png" className="absolute -top-8 left-10" />
      <div className="sm:text-[1.6rem] text-[1.1rem] w-[75%]  sm:py-12 pt-7 ">
