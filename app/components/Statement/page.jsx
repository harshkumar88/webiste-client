const StateMent = ({ remove_color }) => {
  return (
    <div
      className={`md:w-[70%] w-[100%]  mx-auto md:p-0 sm:mt-10  pb-10 flex flex-col items-start justify-center relative ${
    ...
    >
      ...
      />
      <div className="sm:text-[1.6rem] text-[1.1rem] md:w-[40%] w-[60%] md:mx-0 mx-auto  md:text-start text-center sm:py-12 pt-7 ">
