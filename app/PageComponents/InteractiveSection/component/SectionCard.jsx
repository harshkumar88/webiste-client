...
const SectionCard = ({ show, item }) => {
  ...
  return (
    <div className=" w-[100%] flex flex-shrink-0  flex-col md:flex-row items-center xsm:gap-[50px] gap-[10px] justify-between  overflow-hidden ">
      ...
      <div className="md:w-[750px] lg:h-[480px] md:h-[350px]  xsm:w-[688px] h-[320px]  flex lg:justify-start justify-center overflow-hidden md:p-0 relative md:rounded-tl-[50px] md:rounded-bl-[50px] ">
        {/* Image Component */}
        {show && (
          <div className="bg-green_gradient xsm:h-[200px] h-[140px] xsm:w-[50px] w-[40px]  rounded-[10px] flex flex-col gap-5 items-center justify-center  absolute xsm:top-[130px] lg:top-[150px] md:top-[110px] top-[110px] lg:left-[38px] md:left-[10px] sm:left-[24px] left-[5px]  z-10">
            <span
        ...
        <div className="absolute  sm:w-[70%] w-[75%] p-4 lg:bottom-[2%] md:bottom-[-5%]  sm:bottom-[1%] bottom-[-1%] lg:left-[31%]  left-[30%] ">
